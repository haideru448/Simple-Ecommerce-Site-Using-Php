...
$query="UPDATE tblproducts SET pname='$pname',pprice='$pprice',pcode='$pcode',pinstock='$pinstock',pdiscount='$pdiscount',psize='$psizes',pdetails='$pdetails',ppicture='$img' WHERE pid='$id'";
...
$id=$_GET['id'];
$q="SELECT * from tblproducts where pid='$id'";
$r=mysqli_query($connection,$q);
$row=mysqli_fetch_array($r);?>
<div class="container-fluid">
<center>
<form action="" method="POST" enctype="multipart/form-data">
ProductName <br><input type="text" name="pname" value="<?php echo $row['pname'];?>" ><br>
Productprice <br><input type="number" name="pprice" value="<?php echo $row['pprice'];?>"><br>
Productcode <br><input type="text" name="pcode" value=<?php echo $row['pcode'];?>><br>
Product Stock <br><select name="pis"><br>
<option value="Y">Y</option>
<option value="N">N</option>
</select><br>
ProductDiscount <br><input type="number" name="pdiscount" value="<?php echo $row['pdiscount'];?>"><br>
Productsizes <br><input type="text" name="psize" value="<?php echo $row['psize'];?>"><br>
Productdetails <br><input type="text" name="pdetail" value="<?php echo $row['pdetails'];?>"><br>
Image<br><input type="file" name="picture" value="<?php echo $row['ppicture'];?>">
